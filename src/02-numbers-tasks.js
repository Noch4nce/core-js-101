...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  // const p1 = x1 - x2;
  // const p2 = y1 - y2;
  // const num = ((((p2.y2 - p1.y1) * (p2.x2 - p1.x1)) * 180) / Math.PI);
  const num = Math.acos(x1 * x2 + y1 * y2);
  const num1 = Math.hypot(x1 + y1);
  const num2 = Math.hypot(x2 + y2);
